...
- (void)setup{
  ...
  UIButton *button = [MHTextField customBtn];
  ...
  [button addTarget:self action:@selector(doneButtonIsClicked:) forControlEvents:UIControlEventTouchUpInside];
